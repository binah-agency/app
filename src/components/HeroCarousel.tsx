...
export default function HeroCarousel() {
  ...
  return (
    <div className="relative w-full h-screen min-h-[100dvh] pb-20 lg:pb-0 bg-gradient-to-br from-blue-900 via-blue-800 to-brand-navy overflow-y-auto">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6 lg:p-12 xl:p-16 pt-20 pb-8 lg:pt-12">
              <div className="max-w-xl text-center animate-in fade-in slide-in-from-left-4 duration-700">
                ...
                {slide.title && (
                  <h1 className={`font-display text-white leading-[0.95] mb-28 lg:mb-36 ${TYPOGRAPHY.display.hero}`}>
                    {slide.title}
                  </h1>
                )}
                {slide.subtitle && (
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-brand-secondary text-neutral-100 px-6 py-3 rounded-full font-accent text-sm font-bold uppercase tracking-[1px] hover:bg-yellow-400 transition-all duration-300 mb-4"
                >
      ...
      <button
        onClick={goToPrev}
        className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/20 hover:bg-white/40 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 z-10 group"
      ...
      <button
        onClick={goToNext}
        className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/20 hover:bg-white/40 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 z-10 group"
