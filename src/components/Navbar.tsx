...
export default function Navbar() {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 bg-brand-secondary text-brand-navy px-4 py-2 font-accent text-sm font-medium uppercase tracking-[1px]"
      >
        ...
        <div className="max-w-[1400px] mx-auto h-full flex items-center justify-between px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`lg:hidden p-2 transition-colors duration-400 focus:outline-none focus:ring-2 focus:ring-brand-secondary rounded-md ${
                scrolled ? 'text-brand-navy700' : 'text-white'
              }`}
            >
          ...
          >
            <div className="flex justify-end p-4">
              <button
                ...
                className="p-2 text-brand-navy700 hover:text-brand-secondary focus:outline-none focus:ring-2 focus:ring-brand-secondary rounded-md"
              >
                <X size={28} />
              </button>
            </div>
